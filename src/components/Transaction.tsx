...
const Transaction = ({ transactions, isLoading = false }: TransactionSectionProps) => {
    const shouldShowLoading = isLoading || transactions === undefined;
    ...
    // At this point, transactions is defined (either empty array or has items)
